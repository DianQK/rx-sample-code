...
class VoiceRecordSampleView: UIView {
    ...
    lazy var sampleCollectionView: UICollectionView = {
        ...
        view.register(VoiceRecordSampleCell.self, forCellWithReuseIdentifier: "VoiceRecordSampleCell")
        return view
    }()
    ...
    deinit {
        ...
        print("deinit VoiceRecordSampleView")
    }
    ...
    func makeUI() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(VoiceRecordSampleView.reloadSampleCollectionView(_:)), name: Notification.Name.UIApplicationDidBecomeActive, object: nil)
    }

    @objc private func reloadSampleCollectionView(_ notification: NSNotification) {
...
extension VoiceRecordSampleView: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "VoiceRecordSampleCell", for: indexPath) as! VoiceRecordSampleCell
